...
// Selector de tema v3.1: los 5 temas con su descripción cálida y el fondo
// guía de su swatch (espejo de tiendaReglas.FONDOS_TEMA).
const OPCIONES_TEMA: {
  id: TemaTienda;
  nombre: string;
  desc: string;
  ...
  { id: "auto", nombre: "Auto", desc: "Se adapta al teléfono de tu cliente", fondo: "#f6f7fb", texto: "#232637" },
...
export default function ModalTienda({
  ...
  function renderDiseno() {
    ...
    const nombreTemaElegido =
      OPCIONES_TEMA.find((o) => o.id === cfg.tema)?.nombre ?? "Auto";
    return (
      <>
...
function crearEstilos(T: Tema) {
  return StyleSheet.create({
    ...
    // Tema de la tienda v3.1 (5 opciones con swatch)
