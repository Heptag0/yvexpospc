...
// expo-clipboard NO está instalado en este proyecto (no se agregan
// dependencias nuevas): copiarEnlace() lo intenta con require protegido y,
// si falta el módulo, cae al Share nativo para no dejar al dueño sin forma
// de llevarse su enlace.
