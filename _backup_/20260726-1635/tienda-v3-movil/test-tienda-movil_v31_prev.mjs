...
assert.equal(temaTiendaValido("claro"), "claro");
assert.equal(temaTiendaValido("oscuro"), "oscuro");
assert.equal(temaTiendaValido("auto"), "auto");
assert.equal(temaTiendaValido(" OSCURO "), "oscuro", "mayúsculas y espacios");
...
assert.equal(
  preview,
  "https://tienda.yvexiq.com/t/abarrotes-lupita/preview?plantilla=noche&tema=oscuro&acento=%238b5cf6",
