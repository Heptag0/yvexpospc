...
//   codigos → escanear/registrar códigos de barras (giros de resurtido)
//   fotos   → ponerle foto a productos (giros donde vende la vista)
//   kit     → crear un kit o paquete (comida y bebida)
export type TipoMision4 = "codigos" | "fotos" | "kit";
